...
#
# O arquivo calc.py importa o conteúdo do módulo parser e
# fornece scripts úteis
# para testar o analisador sintático
# interativamente a partir da linha de comando.
#
import parser
...
def repl():
    ...
    print('O comando "debug" mostra ou oculta as '
